...
public class Calculator {
  ...
  public static void readInput() {
    ...
    input.close();
    Calculator.buildOutput(container_height, rotations_allowed, number_of_rectangles, rectangle_sizes);
  }
  
  /*
   * Builds txt file using the output rules.
   */
  public static void buildOutput(String container_height, String rotations_allowed, int number_of_rectangles, 
